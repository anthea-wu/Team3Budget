...
public class BudgetServiceTests
{
    ...
    public void query_single_day()
    {
        ...
        DateTime queryDate = new DateTime(2023, 11, 25);
    ...
    public void query_multi_days_in_same_month()
    {
        ...
        DateTime start = new DateTime(2023, 11, 25);
        DateTime end = new DateTime(2023, 11, 27);
    ...
    public void query_multi_days_in_different_month()
    {
        ...
        DateTime start = new DateTime(2023, 10, 30);
        DateTime end = new DateTime(2023, 11, 3);
    ...
    public void query_multi_days_across_three_month()
    {
        ...
        DateTime start = new DateTime(2023, 09, 30);
        DateTime end = new DateTime(2023, 11, 3);
   ...
   [Test]
    ...
    public void query_multi_days_across_year()
    {
        ...
        DateTime start = new DateTime(2023, 12, 30);
        DateTime end = new DateTime(2024, 01, 1);
    ...
    public void query_invalid_query_day()
    {
        ...
        DateTime start = new DateTime(2023, 11, 4);
        DateTime end = new DateTime(2023, 11, 3);
